...
const CollapsableSection = (props) => {
    ...
    return (
        <>
            <CollapseIcons toggleIsFavorite={props.toggleIsFavorite} isFavorite={props.isFavorite} handleExpandClick={handleExpandClick} isExpanded={isExpanded}></CollapseIcons>
